...
func vanilla_2441822890_add_gold(amount: float, silence: Array[bool] = [false, false]) -> void :
...
func vanilla_2441822890_add_diamonds(player: Player, amount: float, silent: bool = false) -> void :
	if not amount:
		return
...
func vanilla_2441822890_refill_magic_shield(character: Character) -> void :
...
func vanilla_2441822890_add_stat(character: Character, stat: BonusStat, silent: bool = false) -> void :
...
func vanilla_2441822890_add_temp_stat(character: Character, stat: BonusStat, silent: bool = false) -> void :
...
func vanilla_2441822890_pay(price: Price, silent: bool) -> void :
...
func vanilla_2441822890_add_loot(item_to_add: Item) -> void :
...
func vanilla_2441822890_add_item(item_to_add: ItemResource, rarity: int = 0):
...
func vanilla_2441822890_drop_item(item: Item, silent = false) -> void :
...
func vanilla_2441822890_try_to_tinker(slot: Slot) -> void :
...
func vanilla_2441822890_split_item(slot: Slot) -> void :
...
func vanilla_2441822890_can_pay(price: Price) -> bool:
...
func vanilla_2441822890_use_mana(_battle: Battle, character: Character, amount: int) -> void :
	if not amount:
		return
...
func vanilla_2441822890_regen_mana(character: Character, amount: int) -> void :
...
func vanilla_2441822890_can_swap_equipment(character: Character) -> ItemPressResult.Type:
...
func vanilla_2441822890_process_stat_effects(battle: Battle) -> void :
...
func vanilla_2441822890_can_use_ability(battle: Battle, character: Character, ability: AbilityResource) -> Character.UseAbilityResult:
...
func vanilla_2441822890_try_to_rest() -> void :
...
func add_gold(amount: float, silence: Array[bool]=[false, false]):
	if _ModLoaderHooks.any_mod_hooked:
		await _ModLoaderHooks.call_hooks_async(vanilla_2441822890_add_gold, [amount, silence], 3812034968)
	else:
		await vanilla_2441822890_add_gold(amount, silence)


func add_diamonds(player: Player, amount: float, silent: bool=false):
	if _ModLoaderHooks.any_mod_hooked:
		await _ModLoaderHooks.call_hooks_async(vanilla_2441822890_add_diamonds, [player, amount, silent], 2833778529)
	else:
		await vanilla_2441822890_add_diamonds(player, amount, silent)


func refill_magic_shield(character: Character):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_2441822890_refill_magic_shield, [character], 519051520)
	else:
		vanilla_2441822890_refill_magic_shield(character)


func add_stat(character: Character, stat: BonusStat, silent: bool=false):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_2441822890_add_stat, [character, stat, silent], 3812471310)
	else:
		vanilla_2441822890_add_stat(character, stat, silent)


func add_temp_stat(character: Character, stat: BonusStat, silent: bool=false):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_2441822890_add_temp_stat, [character, stat, silent], 4265900803)
	else:
		vanilla_2441822890_add_temp_stat(character, stat, silent)


func pay(price: Price, silent: bool):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_2441822890_pay, [price, silent], 1312498644)
	else:
		vanilla_2441822890_pay(price, silent)


func add_loot(item_to_add: Item):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_2441822890_add_loot, [item_to_add], 3812214768)
	else:
		vanilla_2441822890_add_loot(item_to_add)


func add_item(item_to_add: ItemResource, rarity: int=0):
	if _ModLoaderHooks.any_mod_hooked:
		return _ModLoaderHooks.call_hooks(vanilla_2441822890_add_item, [item_to_add, rarity], 3812112065)
	else:
		return vanilla_2441822890_add_item(item_to_add, rarity)


func drop_item(item: Item, silent=false):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_2441822890_drop_item, [item, silent], 150705965)
	else:
		vanilla_2441822890_drop_item(item, silent)


func try_to_tinker(slot: Slot):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_2441822890_try_to_tinker, [slot], 2401622871)
	else:
		vanilla_2441822890_try_to_tinker(slot)


func split_item(slot: Slot):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_2441822890_split_item, [slot], 3434646276)
	else:
		vanilla_2441822890_split_item(slot)


func can_pay(price: Price) -> bool:
	if _ModLoaderHooks.any_mod_hooked:
		return _ModLoaderHooks.call_hooks(vanilla_2441822890_can_pay, [price], 2462764005)
	else:
		return vanilla_2441822890_can_pay(price)


func use_mana(_battle: Battle, character: Character, amount: int):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_2441822890_use_mana, [_battle, character, amount], 3713888787)
	else:
		vanilla_2441822890_use_mana(_battle, character, amount)


func regen_mana(character: Character, amount: int):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_2441822890_regen_mana, [character, amount], 3894800759)
	else:
		vanilla_2441822890_regen_mana(character, amount)


func can_swap_equipment(character: Character) -> ItemPressResult.Type:
	if _ModLoaderHooks.any_mod_hooked:
		return _ModLoaderHooks.call_hooks(vanilla_2441822890_can_swap_equipment, [character], 4101606477)
	else:
		return vanilla_2441822890_can_swap_equipment(character)


func process_stat_effects(battle: Battle):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_2441822890_process_stat_effects, [battle], 1357550435)
	else:
		vanilla_2441822890_process_stat_effects(battle)


func can_use_ability(battle: Battle, character: Character, ability: AbilityResource) -> Character.UseAbilityResult:
	if _ModLoaderHooks.any_mod_hooked:
		return _ModLoaderHooks.call_hooks(vanilla_2441822890_can_use_ability, [battle, character, ability], 722301333)
	else:
		return vanilla_2441822890_can_use_ability(battle, character, ability)


func try_to_rest():
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_2441822890_try_to_rest, [], 3315051720)
	else:
		vanilla_2441822890_try_to_rest()
